<section class="mb-32 py-10 lg:py-14" id="testimoni">
                    ...
                    <div class="group bg-white border border-solid border-gray-300 rounded-xl p-6 transition-all duration-500 hover:border-amber-500 hover:shadow-sm flex-shrink-0 w-full h-full">
                      <div class="">
                          <div class="flex items-center mb-7 gap-2 text-amber-500 transition-all duration-500 justify-center">
                              ...
                              <span class="text-base font-semibold text-amber-500">5</span>
                          </div>
                          <p class="text-base text-gray-600 leading-6 transition-all duration-500 pb-8 group-hover:text-gray-800">
                              Pelayanan yang bagus serta harga yang terjangkau. Tempat yang sempurna sekali untuk membeli motor second
                          </p>
                      </div>
                      <div class="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                          ...
                          <div class="block">
                              <h5 class="text-gray-900 font-medium transition-all duration-500 mb-1">Ditya Bagus</h5>
                          </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="hs-carousel-slide px-1">
                    <div class="group bg-white border border-solid border-gray-300 rounded-xl p-6 transition-all duration-500 hover:border-amber-500 hover:shadow-sm flex-shrink-0 w-full h-full">
                      <div class="">
                          ...
                          <p class="text-base text-gray-600 leading-6 transition-all duration-500 pb-8 group-hover:text-gray-800">
                              motor motornya bagus dan terjamin, udah gitu pelayanannya cepet banget lagi 🤩🤩 …
                          </p>
                      </div>
                      <div class="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                          <img class="rounded-full h-10 w-10 object-cover" src="https://pagedone.io/asset/uploads/1696229994.png" alt="avatar" />
                          <div class="block">
                              <h5 class="text-gray-900 font-medium transition-all duration-500 mb-1">Orlina Putri</h5>
                          </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="hs-carousel-slide px-1">
                    <div class="group bg-white border border-solid border-gray-300 rounded-xl p-6 transition-all duration-500 hover:border-amber-500 hover:shadow-sm flex-shrink-0 w-full h-full">
                      <div class="">
                          ...
                          <p class="text-base text-gray-600 leading-6 transition-all duration-500 pb-8 group-hover:text-gray-800">
                              Tempat beli motor paling recommended. Harga pas, pelayanan mantap. Ga nyesel deh pokoknya
                          </p>
                      </div>
                      <div class="flex items-center gap-5 border-t border-solid border-gray-200 pt-5">
                          <img class="rounded-full h-10 w-10 object-cover" src="https://pagedone.io/asset/uploads/1696230027.png" alt="avatar" />
                          <div class="block">
                              <h5 class="text-gray-900 font-medium transition-all duration-500 mb-1">Wayan Galih Putra Sangging</h5>
                          </div>
                      </div>
                    </div>
                  </div>
