    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-y-4 items-start mb-10">
        ...
        <div class="col-span-2 lg:col-span-1">
            ...
            <ul class="mt-3 space-y-2 text-sm text-white">
                <li><a class="hover:text-slate-400" href="#">Pricing</a></li>
                <li><a class="hover:text-slate-400" href="#">Changelog</a></li>
                <li><a class="hover:text-slate-400" href="#">Download</a></li>
                <li><a class="hover:text-slate-400" href="#">Docs</a></li>
            </ul>
        </div>

    </div>
    <div class="flex justify-center sm:justify-center md:justify-end">
        <p class="text-sm text-white">Copyright 2024 ・ Ananda Krizora</p>
    </div>
</footer>
